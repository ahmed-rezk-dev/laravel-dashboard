			...
			<div class="content-wrapper">
				...
				<div class="content">
					...
					<form action="{{url('login')}}" method="POST" role="form" class="form-validate">
						...
						<div class="panel panel-body login-form">
							<div class="text-center">
								...
								<h5 class="content-group"> تسجيل دخول <small class="display-block"> لوحة تحكم Ahmed Rezk </small></h5>
							</div>
					...
					<div class="footer text-white">
						<a href="https://ahmed-rezk.herokuapp.com/" class="text-white">جميع الحقوق محفوظه لــ Ahmed Rezk &copy; 2017. </a>
					</div>
					<!-- /footer -->
