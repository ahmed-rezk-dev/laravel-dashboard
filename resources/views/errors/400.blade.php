			...
			<div class="content-wrapper">
				...
				<div class="content">
					...
					<div class="container-fluid text-center">
						...
						<span class="text-semibold content-group" style="display: block;font-size: 20px;color: red">
							هذا الموقع غير مرخص للعمل يرجى مراجعة
							<a href="https://ahmed-rezk.herokuapp.com/contact">Ahmed Rezk</a></span><br>
						{{bcrypt(111111)}}
					</div>
					<!-- /error wrapper -->
